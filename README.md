...
`build` y `deploy`, que se encarguen de arrancar, correr las pruebas,
...
2. Clona tu _fork_ en tu computadora:
   ...
   ```sh
   git clone https://github.com/<username>/lim-2018-01-burger-queen.git
   cd lim-2018-01-burger-queen
   ```
...
7. Ahora usa el siguiente comando para acceder con tu cuenta de Google:
...
* [ ] Inicio de sesión.
* [ ] Restaurar contraseña.
* [ ] 70% o más en cobertura de Tests: _statements_, _functions_, _lines_,
 _branches_.
